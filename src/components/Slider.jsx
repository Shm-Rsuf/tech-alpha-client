  ...
  return (
    <div className="frame relative">
      ...
      <div className="btns absolute z-[1] text-gray-50 text-2xl flex gap-10 bottom-10 w-screen justify-center">
        <button
          onClick={prevSlide}
          className="prev-btn h-10 w-14 flex justify-center items-center bg-violet-800 text-violet-200 border-2 border-violet-200 hover:bg-gray-900 hover:text-gray-300 hover:border-gray-300 duration-300"
        >
          <span>
            <BsArrowLeft />
          </span>
        ...
        <button
          onClick={nextSlide}
          className="next-btn h-10 w-14 flex justify-center items-center bg-violet-800 text-violet-200  border-2 border-violet-200 hover:bg-gray-900 hover:text-gray-300 hover:border-gray-300 duration-300"
        >
          <span>
            <BsArrowRight />
          </span>
